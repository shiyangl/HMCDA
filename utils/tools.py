...
def parse_minibatch_HMCDA(adjlists_cd, edge_metapath_indices_list_cd, circrna_disease_batch, device, samples=None, use_masks=None, offset=None):
    g_lists = [[], []]
    result_indices_lists = [[], []]
    idx_batch_mapped_lists = [[], []]
    for mode, (adjlists, edge_metapath_indices_list) in enumerate(zip(adjlists_cd, edge_metapath_indices_list_cd)):
...
def parse_minibatch_HMCDA_gene(adjlists_cd, edge_metapath_indices_list_cd, circrna_disease_batch, device, samples=None, use_masks=None, offset=None):
    g_lists = [[], []]
    result_indices_lists = [[], []]
    idx_batch_mapped_lists = [[], []]
    for mode, (adjlists, edge_metapath_indices_list) in enumerate(zip(adjlists_cd, edge_metapath_indices_list_cd)):
